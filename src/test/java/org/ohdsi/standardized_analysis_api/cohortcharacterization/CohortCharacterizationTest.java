        ...
        CohortCharacterization cc = new CohortCharacterization() {
            ...
            public List<FeatureAnalysis> getFeatureAnalyses() {
                ...
                FeatureAnalysis criteriaAnalysis = new FeatureAnalysis() {
                    ...
                    public List<InclusionRule> getDesign() {
                        ...
                        InclusionRule maleInclusionRule = new InclusionRule();
                        maleInclusionRule.name = "Male";
                        maleInclusionRule.expression = maleGroup;
                        ...
                        InclusionRule femaleInclusionRule = new InclusionRule();
                        femaleInclusionRule.name = "Female";
                        femaleInclusionRule.expression = femaleGroup;

                        return Arrays.asList(maleInclusionRule, femaleInclusionRule);
                    }
                };
